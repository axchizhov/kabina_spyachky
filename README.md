...
Использование этих идей позволяет генерировать субъект в новых контекстах, сохраняя стиль и мелкие детали субъекта. Кроме этого, существенно снижаются требования к количеству экземпляров субъекта для обучения: со 100 до 3-5 штук.
